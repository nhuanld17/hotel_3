...
public class KhachHangGUI extends JFrame {
    ...
    public KhachHangGUI() {
        ...
        separator.setBounds(10, 159, 589, 2);
        ...
        textField_FindName.setFont(new Font("Tahoma", Font.PLAIN, 16));
        textField_FindName.setColumns(10);
        textField_FindName.setBackground(SystemColor.control);
        ...
        btn_reload.setForeground(new Color(255, 255, 255));
        ...
        rdbtn_GetEmpty.setBackground(new Color(34, 49, 63));
        rdbtn_GetEmpty.setFont(new Font("Tahoma", Font.BOLD, 16));
        rdbtn_GetEmpty.setBounds(587, 64, 239, 23);
        ...
        rdbtn_GetOrdered.setFont(new Font("Tahoma", Font.BOLD, 16));
        rdbtn_GetOrdered.setBackground(new Color(34, 49, 63));
        ...
        rdbtn_GetAll.setFont(new Font("Tahoma", Font.BOLD, 16));
        rdbtn_GetAll.setBackground(new Color(34, 49, 63));
